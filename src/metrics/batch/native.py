...
def confidence_score(
    ...
    min_transfer_total: int=src.options.MIN_TRANSFER_TOTAL_NATIVE,
    ...
    _scores.append(src.metrics.probabilities.indicator_to_probability(
        indicator=src.indicators.batch.transaction_value_matches_input_arrays(value=_value, data=_data, min_count=min_transfer_count, tolerance=max_batching_fee),
